...
// Mon Sep  9 23:06:45 2019 by ROOT version 5.34/25
// from TTree gst/GENIE Summary Event Tree
// found on file: gntp.1000.gst.286.root
//////////////////////////////////////////////////////////

#ifndef GENIEEventHisto_h
#define GENIEEventHisto_h
...
public :
   ...
   GENIEEventHisto(TTree *tree=0);
   virtual ~GENIEEventHisto();
...
#ifdef GENIEEventHisto_cxx
GENIEEventHisto::GENIEEventHisto(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("gntp.1000.gst.286.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("gntp.1000.gst.286.root");
      }
...
GENIEEventHisto::~GENIEEventHisto()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t GENIEEventHisto::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GENIEEventHisto::LoadTree(Long64_t entry)
{
...
void GENIEEventHisto::Init(TTree *tree)
{
...
void GENIEEventHisto::Show(Long64_t entry)
{
...
Int_t GENIEEventHisto::Cut(Long64_t entry)
{
...
#endif // #ifdef GENIEEventHisto_cxx
