/**
 * \file DUNEAnalogger.h
 *
 * \ingroup Base
 * 
 * \brief Class def header for a class DUNEAnalogger
 *
 * @author jiangl
 */
...
/** \addtogroup Base
    ...
    @{*/
#ifndef __BASE_DUNEANALOGGER_H__
#define __BASE_DUNEANALOGGER_H__
...
namespace Base {
  /**
     \class DUNEAnalogger
     User defined class DUNEAnalogger ... these comments are used to generate
